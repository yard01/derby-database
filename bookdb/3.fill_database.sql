connect 'jdbc:derby:/home/yard/projects/databases/simpleDB;user=dba;password=12345';
set role dbadmin;
DELETE FROM SECURITY.WEBUSERS;
DELETE FROM SECURITY.WEBROLES;

INSERT INTO SECURITY.WEBROLES(ID, NAME, DBROLE) VALUES (1, 'Administrator', 'dbwriter');
INSERT INTO SECURITY.WEBROLES(ID, NAME, DBROLE) VALUES (2, 'User', 'dbreader');

INSERT INTO SECURITY.WEBUSERS(ID, NAME, WEBROLE) VALUES (1, 'alice', 2);
INSERT INTO SECURITY.WEBUSERS(ID, NAME, WEBROLE) VALUES (2, 'bob', 1);

DELETE FROM HOMEDB.LNK_TYPES_ITEMS;
DELETE FROM HOMEDB.HUB_TYPES;
DELETE FROM HOMEDB.HUB_ITEMS;
INSERT INTO HOMEDB.HUB_TYPES(ID, NAME) VALUES (1, 'MUSIC');
INSERT INTO HOMEDB.HUB_TYPES(ID, NAME) VALUES (2, 'BOOK');
INSERT INTO HOMEDB.HUB_TYPES(ID, NAME) VALUES (3, 'MOVIE');


INSERT INTO HOMEDB.HUB_ITEMS(ID, CODE) VALUES (1, 'B00001');
INSERT INTO HOMEDB.LNK_TYPES_ITEMS(ID, HUB_ITEM, HUB_TYPE) VALUES (1, 1, 2);

INSERT INTO HOMEDB.HUB_ITEMS(ID, CODE) VALUES (2, 'B00002');
INSERT INTO HOMEDB.LNK_TYPES_ITEMS(ID, HUB_ITEM, HUB_TYPE) VALUES (2, 2, 2);

INSERT INTO HOMEDB.HUB_ITEMS(ID, CODE) VALUES (3, 'B00003');
INSERT INTO HOMEDB.LNK_TYPES_ITEMS(ID, HUB_ITEM, HUB_TYPE) VALUES (3, 3, 2);

INSERT INTO HOMEDB.HUB_ITEMS(ID, CODE) VALUES (4, 'B00004');
INSERT INTO HOMEDB.LNK_TYPES_ITEMS(ID, HUB_ITEM, HUB_TYPE) VALUES (4, 4, 2);

INSERT INTO HOMEDB.HUB_ITEMS(ID, CODE) VALUES (5, 'B00005');
INSERT INTO HOMEDB.LNK_TYPES_ITEMS(ID, HUB_ITEM, HUB_TYPE) VALUES (5, 5, 2);

DELETE FROM HOMEDB.SAT_BOOKS;
INSERT INTO HOMEDB.SAT_BOOKS(ID, HUB_ITEM, AUTHOR, NAME, SERIES, GENRE, PBYEAR, PUBLISHER, NOTE)
